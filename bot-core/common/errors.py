...
class InvalidDateError(InCommandError):
    ...
    def __init__(
        self, message: str = "Could not find anything for that date, sorry."
    ) -> None:
...
class InvalidPlayerError(InCommandError):
    ...
    def __init__(
        self,
        message: str = "Could not find player. Check for spelling mistakes or try using "
...
class NotInVoiceChannelError(InCommandError):
    ...
    def __init__(
        self,
        message: str = "You must be in a voice channel in order to use this command!",
    ) -> None:
...
class QueueTooShortError(InCommandError):
    ...
    def __init__(
        self, message: str = "Queue is not long enough to skip to that index."
    ) -> None:
